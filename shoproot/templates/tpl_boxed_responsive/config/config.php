...
/* -----------------------------------------------------------------------------------------
  ...
  // template output
  define('THEME_COLOR', 'red'); // possible: green, blue, magenta, orange, red, purple - you have to clear the template cache after changing
  define('TEMPLATE_ENGINE', 'smarty_4'); // 'smarty_4' oder 'smarty_3' oder 'smarty_2' -> Nicht �ndern! (Nur "smarty_4" oder "smarty_3" unterst�tzt die custom Sprachdateien (lang_english.custom & lang_german.custom) aus dem Ordner "../lang/" des Templates!)
